...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an Open Orgo Bot package" }),
 ...
 * run without Open Orgo Bot or another proprietary parser. */
