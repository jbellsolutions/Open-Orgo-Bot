...
/** FTS5 is in every runtime Open Orgo Bot supports — node:sqlite on Node ≥ 24
...
export function describeMissingFts5(error: unknown): Error | null {
  ...
  return new Error(
    `Open Orgo Bot needs SQLite with FTS5, which is built into Node 24 and newer (and into the app). ` +
