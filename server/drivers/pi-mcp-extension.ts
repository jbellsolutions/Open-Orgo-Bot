...
// there as first-class pi tools (pi.registerTool). Open Orgo Bot ships this file
// and the pi driver spawns it — the pi repo itself is never touched.
//
// Protocol: the Open Orgo Bot proxies speak raw JSON-RPC 2.0 over stdio, one
 ...
 * Keeping it local avoids bundling Pi into Open Orgo Bot; the extension is
...
/** A minimal stdio JSON-RPC 2.0 MCP client, matched to Open Orgo Bot's
