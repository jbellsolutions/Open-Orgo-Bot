...
describe("organisation desktop policy overlay", () => {
  ...
  it("maps every computer claim to its kind and refuses disallowed ones", () => {
    ...
    expect(computerKindForResource("computer:orgo:11111111-1111-4111-8111-111111111111")).toBe("box");
    expect(computerKindForResource("computer:orgo-bot:bot-1")).toBe("box");
    ...
    expect(managed.computerRefusal("box")).toBe("Fixture Agency does not allow bots to use Orgo cloud computers.");
...
describe("claim-time computer refusal in bindTurnComputer", () => {
  ...
  it("refuses a disallowed kind before claiming anything", async () => {
    ...
    await expect(bindTurnComputer({}, "computer:orgo:11111111-1111-4111-8111-111111111111")).rejects.toThrow("Orgo cloud computers");
    await expect(bindTurnComputer({}, "computer:orgo-bot:bot-1")).rejects.toThrow("Orgo cloud computers");
    managed.apply(null);
