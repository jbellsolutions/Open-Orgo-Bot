...
const SUBJECTS = {
  "sign-in": "Your Open Orgo Bot sign-in code",
  "email-verification": "Verify your Open Orgo Bot email",
  "forget-password": "Reset your Open Orgo Bot password",
  "change-email": "Confirm your Open Orgo Bot email change",
...
export function buildOTPEmail(from: string, input: OTPEmailInput) {
  ...
  return {
    to: input.email,
    from: { email: from, name: "Open Orgo Bot" },
    subject,
    html,
    text,
  };
