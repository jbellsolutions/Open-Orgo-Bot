# Open Orgo Bot Contributor License Agreement

This agreement covers contributions to the `enterprise/` directory of the
Open Orgo Bot repository, which is licensed under the Open Orgo Bot Enterprise
...
1. **Copyright license.** You grant Milind Soni ("the Project Owner") and
   ...
   under any license, including the Open Orgo Bot Enterprise License and the
   Apache License 2.0.
