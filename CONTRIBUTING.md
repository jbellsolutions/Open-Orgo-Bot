...
- stable `Open Orgo Bot-amd64.deb` and `Open Orgo Bot.AppImage` copies used by the latest-download links;
...
[Open Orgo Bot releases](https://github.com/jbellsolutions/open-orgo-bot/releases). Then verify the checksum
...
Open Orgo Bot release repository, and never change the upstream publish target in a feature PR unless
