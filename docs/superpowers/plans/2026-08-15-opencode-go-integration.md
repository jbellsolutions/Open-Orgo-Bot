...
**Goal:** Add OpenCode Go as an optional ACP-backed Open Orgo Bot engine with dynamic models, write-only credentials, setup UX, and comprehensive tests.
...
- [ ] Add cross-platform setup commands, docs URL, and a login note that never asks Open Orgo Bot to edit OpenCode auth files.
