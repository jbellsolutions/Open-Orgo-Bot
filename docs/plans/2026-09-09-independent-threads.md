...
Open Orgo Bot's store, provider adapters, MCP bridge and UI components; no new
...
Adapt the interaction patterns to existing Open Orgo Bot components. If copying
