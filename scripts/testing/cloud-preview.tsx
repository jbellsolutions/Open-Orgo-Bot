...
window.fetch = async (input, init) => {
  ...
  if (/^\/api\/bots\/[\w-]+\/computer$/.test(path)) return json({
    surface: surfaceScenario === "auto-vm" ? "vm" : "cloud",
    configured: true,
  ...
  // The real server refuses provision/sleep while a turn owns the Orgo computer.
