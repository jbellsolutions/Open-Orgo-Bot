...
// transport simulated. No Orgo account or user's app data is contacted.
...
try {
  await runControlOmb(["new-bot", "--name", "Orgo Preview Test", "--url", fixture.info.url]);
  ui = await mountPreview(fixture, {
    entry: "/scripts/testing/cloud-preview.tsx", route: "/__cloud-preview.html", title: "Isolated Orgo Preview Test",
  });
