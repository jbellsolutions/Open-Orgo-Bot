...
try {
  ...
  if (status.startsWith("ii")) fail("refusing to replace a pre-existing Open Orgo Bot installation");
} catch (error) {
...
try {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      "Description: Legacy Open Orgo Bot directory-mode upgrade fixture",
      "",
    ].join("\n"),
    { mode: 0o644 },
  );
