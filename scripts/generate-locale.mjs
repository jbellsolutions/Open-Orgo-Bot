...
function translationPrompt(source, label, code) {
  return [
    `Translate this JSON UI catalog for Open Orgo Bot, a multi-agent desktop workbench, into ${label} (${code}).`,
    ...
    "Keep placeholders such as {name} exactly, including duplicates. Keep Open Orgo Bot, CLI, and AI unchanged.",
