...
export function callCapabilityHelp(
    ...
    switch (capabilities.dictation.reasonCode) {
      ...
      case "desktop-app-required":
        return {
          ...
          reason: "Open this workspace in Open Orgo Bot for macOS to make calls with on-device speech recognition.",
        };
  ...
  if (!speechServiceAvailable) {
    return {
      ...
      reason: "The speech service is unavailable in this app build. Restart or update Open Orgo Bot.",
    };
  }
  return null;
}
