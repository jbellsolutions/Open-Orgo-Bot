// The Orgo / Self-hosted VPS segmented control shown under the "Runs on"
  ...
  return (
    <div className="mt-3 rounded-lg bg-inset p-3">
      ...
      <div className="mt-0.5 text-[11.5px] text-ink-secondary">
        {compact
          ? value === "vps" ? "Your own server, connected over SSH." : "A hosted computer managed by Orgo."
          : value === "vps"
          ...
          : "Orgo is the default hosted computer. Choose Self-hosted VPS to use your SSH-configured Linux Docker host."}
      </div>
      <div className="mt-2 flex overflow-hidden rounded-lg border border-hairline/40">
        {(["orgo", "vps"] as const).map((backend, i) => {
          ...
          return (
            ...
            >
              {backend === "vps" ? "Self-hosted VPS" : "Orgo"}
            </button>
          );
        })}
      </div>
