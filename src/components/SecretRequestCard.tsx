...
export function SecretRequestCard({
  ...
  const description = provided
    ...
    : declined
      ? "You chose not to provide this credential. Open Orgo Bot could not resume the bot yet."
      : secret.description;
          ...
          <div className="min-w-0 flex-1">
            ...
            {!provided && !declined && (
              <p className="mt-1 flex items-center gap-1 text-[11.5px] text-ink-secondary/80">
                <LockKeyhole size={11} /> Stored securely by Open Orgo Bot and never added to chat.
              </p>
            )}
