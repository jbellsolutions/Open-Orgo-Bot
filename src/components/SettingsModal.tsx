...
import { ApiKeyRow, OpenAiCompatUrl, OrgoWorkspace, VpsConnection } from "./ApiKeys";
...
const SECTIONS: Array<{
  ...
  { id: "connections", labelKey: "settings.section.connections", icon: KeyRound, keywords: ["keys", "api", "composio", "orgo", "xai", "mistral", "vps"] },
